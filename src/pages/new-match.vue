    ...
    <v-card-text>
      <v-form class="mt-4" @submit.prevent="handleSubmit">
        ...
        <TeamMembersSelection
          ...
          :is-home-team="true"
          :pos1="newMatch.homePos1"
          :pos2="newMatch.homePos2"
          :pos3="newMatch.homePos3"
          :pos4="newMatch.homePos4"
          :pos5="newMatch.homePos5"
          :pos6="newMatch.homePos6"
          :pos7="newMatch.homePos7"
